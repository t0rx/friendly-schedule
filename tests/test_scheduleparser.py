...
import friendlyschedule.scheduleparser as sp
...
class TestScheduleParser(unittest.TestCase):
    ...
    def test_parse_bad_day(self):
        ...
        with self.assertRaisesRegex(sp.Invalid,
    ...
    def test_parse_bad_time(self):
        ...
        with self.assertRaisesRegex(sp.Invalid, 'Bad time format: "Blah"'):
    ...
    def test_parse_bad_time_part(self):
        ...
        with self.assertRaisesRegex(sp.Invalid, msg):
